...
export const neonAimArenaAssets = {
  ...
  weapons: [
    ...
    },
    {
      ...
      fire: { style: "hand-cannon", auto: false, interval: 0.3, range: 82, damage: 2, spread: 0.0009, recoil: 0.24, pitchKick: 0.0078, yawKick: 0.002, aimAssist: 0.018, hitRadius: 0.15, mobility: 1, tracerSpeed: 118, tracerLength: 1.45, tracerRadius: 0.024, tracerLifetime: 1, flashScale: 1.5, muzzleIntensity: 18, tracerColor: 0xff8a32, hitColor: 0xffdf8a, missDistance: 52 }
    },
    {
      ...
      fire: { style: "quick-burst", auto: true, interval: 0.16, range: 48, damage: 1, spread: 0.0042, projectiles: 2, recoil: 0.11, pitchKick: 0.0038, yawKick: 0.0015, aimAssist: 0.02, hitRadius: 0.16, mobility: 1.05, tracerSpeed: 92, tracerLength: 1.2, tracerRadius: 0.013, tracerLifetime: 1, flashScale: 1.12, muzzleIntensity: 13, tracerColor: 0x9fe8ff, hitColor: 0xd8fbff, missDistance: 34 }
    },
    {
      id: "rifle",
      name: "Rifle",
      ...
      fire: { style: "rifle", auto: true, interval: 0.14, range: 82, damage: 1, spread: 0.0025, recoil: 0.105, pitchKick: 0.0042, yawKick: 0.0018, aimAssist: 0.014, hitRadius: 0.115, mobility: 1, tracerSpeed: 245, tracerLength: 3.4, tracerRadius: 0.009, tracerLifetime: 1, flashScale: 1.02, muzzleIntensity: 12, tracerColor: 0x64d6ff, hitColor: 0xffdf8a, missDistance: 48 }
    },
    {
      id: "sniper-rifle",
      name: "Sniper Rifle",
      ...
      fire: { style: "sniper", auto: false, interval: 0.58, range: 132, damage: 3, spread: 0.00025, recoil: 0.42, pitchKick: 0.016, yawKick: 0.003, aimAssist: 0.013, hitRadius: 0.13, mobility: 0.92, tracerSpeed: 0, tracerLength: 132, tracerRadius: 0.022, tracerLifetime: 1, flashScale: 1.9, muzzleIntensity: 24, tracerColor: 0xf7fbff, hitColor: 0xffffff, missDistance: 92 }
    },
    {
      id: "ray-gun",
      name: "Ray Gun",
    ...
    },
    {
      ...
      fire: { style: "lightning", auto: true, interval: 0.17, range: 44, damage: 1, spread: 0.008, projectiles: 4, recoil: 0.16, pitchKick: 0.0048, yawKick: 0.0028, aimAssist: 0.02, hitRadius: 0.18, mobility: 0.93, tracerSpeed: 0, tracerLength: 44, tracerRadius: 0.013, tracerLifetime: 1, flashScale: 1.35, muzzleIntensity: 18, tracerColor: 0xb465ff, hitColor: 0xf1d6ff, missDistance: 34 }
    }
  ].map((weapon, index) => ({
    ...weapon,
    slot: index,
